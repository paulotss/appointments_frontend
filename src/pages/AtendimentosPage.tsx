...
export function AtendimentosPage() {
  ...
  useEffect(() => {
    async function carregar() {
      ...
      try {
        ...
        const [registrosData, usuariosData] = await Promise.all([
          exportarRegistros({ from, to }),
          listarUsuarios(),
        ])
  ...
  const registrosFiltrados = useMemo(() => {
    return registros.filter((r) => !usuarioSelecionado || r.atendente === usuarioSelecionado)
  }, [registros, usuarioSelecionado])
